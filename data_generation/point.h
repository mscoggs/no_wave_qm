...
public:
  ...
  */
  void init_point(int config_dimension,double *mass, int grid_length, int num_particles, int spatial_dimension, int index, int rho_function, int vel_function, int v_function);
