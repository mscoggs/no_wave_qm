...
void Point::init_point(int config_dimension, double *mass, int grid_length, int num_particles, int spatial_dimension, int index, int psi_function, int v_function, double coord_to_distance){
  int i, remainder;
  ...
  rho = calc_rho_vel_initial(coordinates, velocities, config_dimension, grid_length, mass,psi_function, coord_to_distance);
